...
for nation in nations:
  ...
  (df[df['nationality']=='England']['month'].value_counts(normalize=True)*100).sort_index().plot()
plt.text(1,15,'English Players by Birth Month', fontsize=16, fontweight=300)
plt.xlabel('Month')
plt.ylabel('Players')
